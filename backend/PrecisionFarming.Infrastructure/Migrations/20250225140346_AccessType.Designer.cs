...
namespace PrecisionFarming.Infrastructure.Migrations
{
    ...
    [Migration("20250225140346_AccessType")]
            ...
            modelBuilder.Entity("PrecisionFarming.Domain.Entities.Crop", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7166),
                            Name = "Alfalfa"
                        },
                        new
                        {
                            Id = new Guid("2db4ee88-2bed-4e64-a95d-0cf667f67370"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7337),
                            Name = "Barley"
                        },
                        new
                        {
                            Id = new Guid("f29bf920-7509-4fef-84cf-5c0f35617035"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7355),
                            Name = "Canola"
                        },
                        new
                        {
                            Id = new Guid("f25a2358-8b43-4a16-8379-8b0313179ec9"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7370),
                            Name = "Corn"
                        },
                        new
                        {
                            Id = new Guid("a936c5d8-2dd2-41e7-b071-68b78c5a48d0"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7397),
                            Name = "Fababean"
                        },
                        new
                        {
                            Id = new Guid("a31b7081-ca69-4548-a614-c9afa1ea0197"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7415),
                            Name = "Oats"
                        },
                        new
                        {
                            Id = new Guid("70916e69-1003-4efb-ac4e-5263dd3ff0c7"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7429),
                            Name = "Peas"
                        },
                        new
                        {
                            Id = new Guid("c7961535-9d7b-433d-9f4f-a458c7c6a3b6"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7444),
                            Name = "Soybeans"
                        },
                        new
                        {
                            Id = new Guid("ca2e08ef-05c4-4855-a3a6-ee40e0ad77ff"),
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(7458),
                            Name = "Wheat"
                        });
                });
            ...
            modelBuilder.Entity("PrecisionFarming.Domain.Entities.CropVariety", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(8696),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(8796),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(8850),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 2, 25, 14, 3, 46, 352, DateTimeKind.Utc).AddTicks(8895),
            ...
            modelBuilder.Entity("PrecisionFarming.Domain.Entities.FarmAccess", b =>
                {
                    b.HasOne("PrecisionFarming.Domain.Entities.Farm", "Farm")
                        .WithMany("FarmAccesses")
                        .HasForeignKey("FarmId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PrecisionFarming.Domain.Entities.Identity.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
